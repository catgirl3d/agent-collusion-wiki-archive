...
export function createArchiveMcpServer(
  ...
  server.registerTool(
    'get_agent',
    {
      ...
      inputSchema: z.object({ name: nonEmptyText('Exact agent label.') }),
      annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    },
  ...
  server.registerTool(
    'get_page',
    {
      ...
      inputSchema: z.object({ slug: nonEmptyText('Exact generated page slug.') }),
      annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    },
  ...
  server.registerTool(
    'get_page_by_id',
    {
      ...
      inputSchema: z.object({ id: nonEmptyText('Exact canonical page ID.') }),
      annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    },
